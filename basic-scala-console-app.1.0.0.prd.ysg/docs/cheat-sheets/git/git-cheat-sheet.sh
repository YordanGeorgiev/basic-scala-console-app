...
# add the remote 
git remote add origin https://github.com/YordanGeorgiev/basic-scala-console-app.git
# initialize a new git repo
git init
# clone the existing repo from the Internet
git clone https://github.com/YordanGeorgiev/basic-scala-console-app.git
...
git add -v --all basic-scala-console-app/basic-scala-console-app.0.1.0.dev.ysg
...
git add -v -n --all basic-scala-console-app.0.8.9.dev.ysg
