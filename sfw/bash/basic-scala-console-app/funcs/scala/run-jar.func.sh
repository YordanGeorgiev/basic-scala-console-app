...
doRunJar(){
	...
	doLog "bash $product_version_dir/sfw/scala/$component_name/target/universal/stage/bin/$component_name"
	bash $product_version_dir/sfw/scala/$component_name/target/universal/stage/bin/$component_name
